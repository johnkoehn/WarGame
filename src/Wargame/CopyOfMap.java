...
public class CopyOfMap {
	...
	// map width and height are measured in the number of tiles that make up the
	// width and height
	...
	public CopyOfMap(int ftileWidth, int ftileHeight, int xMax, int yMax)
	...
	public CopyOfMap(int ftileWidth, int ftileHeight, String fmapFile)
			throws FileNotFoundException {
		tileDeminisons = new Point(ftileWidth, ftileHeight);
		mapFile = fmapFile;
		mapHeight = 0;
