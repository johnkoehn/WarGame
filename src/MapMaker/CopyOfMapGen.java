...
//	private static void biomeReserv(Biome b) {
//		int r = (int) Math.sqrt((double) b.DEFUALT_AREA);
//		int xStart = (int) b.getSeed().getX();
//		int yStart = (int) b.getSeed().getY();
//
//		// Coordinate
...
//	}
//
//	private static void fillReserve(Biome b) {
//		int r = (int) Math.sqrt((double) b.DEFUALT_AREA);
//		// Coordinate
//		for (int y = b.getSeed().y - r; y < b.getSeed().y + r + 1; y++) {
//			for (int x = b.getSeed().x - r; x < b.getSeed().x + r + 1; x++) {
//				// Bound
//				if (x < xSize && x >= 0 && y < ySize && y >= 0) {
//					map[y][x] = b.getType();
//				}
